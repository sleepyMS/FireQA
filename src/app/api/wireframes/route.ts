...
export async function POST(request: NextRequest) {
  ...
  return createSSEStream(async (writer) => {
    ...
    try {
      ...
      logActivity({ organizationId: user.organizationId, actorId: user.userId, action: "generation.completed", jobId, metadata: { type: "wireframes" } });
      ...
      logActivity({ organizationId: user.organizationId, actorId: user.userId, action: "generation.failed", jobId, metadata: { type: "wireframes", error: errMsg } });
